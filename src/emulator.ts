export class Emulator {
	...
	memoryArr: Array<number>;
	stackSize: number;
	programSize: number;
	globalMemory: number;
	registers: Uint8Array = new Uint8Array([0,0,0,0,0]);
	flags: Uint8Array = new Uint8Array(2); // one unsigned 8 bit number
	programCounter: number = 0;
	running: boolean = false;

	constructor(memory: number, stackSize: number) {
	...
	step() {
		...
		if (this.memory[this.programCounter] == 52) {
			this.programCounter++;
			if (this.registers[0] == this.memory[this.programCounter]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[0] > this.memory[this.programCounter]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 53) {
			...
			if (this.registers[0] > res) this.flags[1] = 1;
			else this.flags[1] = 0;
			return;
		}
		// cmp A mem
		if (this.memory[this.programCounter] == 54) {
			this.programCounter++;
			if (this.registers[0] == this.memory[this.memory[this.programCounter]]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[0] > this.memory[this.memory[this.programCounter]]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 55) {
			this.programCounter++;
			if (this.registers[1] == this.memory[this.programCounter]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[1] > this.memory[this.programCounter]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 56) {
			...
			if (this.registers[1] > res) this.flags[1] = 1;
			else this.flags[1] = 0;
			return;
		}
		// cmp B mem
		if (this.memory[this.programCounter] == 57) {
			this.programCounter++;
			if (this.registers[1] == this.memory[this.memory[this.programCounter]]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[1] > this.memory[this.memory[this.programCounter]]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 58) {
			this.programCounter++;
			if (this.registers[2] == this.memory[this.programCounter]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[2] > this.memory[this.programCounter]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 59) {
			...
			if (this.registers[2] > res) this.flags[1] = 1;
			else this.flags[1] = 0;
			return;
		}
		// cmp C mem
		if (this.memory[this.programCounter] == 60) {
			this.programCounter++;
			if (this.registers[2] == this.memory[this.memory[this.programCounter]]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[2] > this.memory[this.memory[this.programCounter]]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 61) {
			this.programCounter++;
			if (this.registers[3] == this.memory[this.programCounter]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[3] > this.memory[this.programCounter]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 62) {
			...
			if (this.registers[3] > res) this.flags[1] = 1;
			else this.flags[1] = 0;
			return;
		}
		// cmp D mem
		if (this.memory[this.programCounter] == 63) {
			this.programCounter++;
			if (this.registers[3] == this.memory[this.memory[this.programCounter]]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[3] > this.memory[this.memory[this.programCounter]]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 64) {
			this.programCounter++;
			if (this.registers[4] == this.memory[this.programCounter]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[4] > this.memory[this.programCounter]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
		...
		if (this.memory[this.programCounter] == 65) {
			...
			if (this.registers[4] > res) this.flags[1] = 1;
			else this.flags[1] = 0;
			return;
		}
		// cmp M mem
		if (this.memory[this.programCounter] == 66) {
			this.programCounter++;
			if (this.registers[4] == this.memory[this.memory[this.programCounter]]) this.flags[0] = 1;
			else this.flags[0] = 0;
			if (this.registers[4] > this.memory[this.memory[this.programCounter]]) this.flags[1] = 1;
			else this.flags[1] = 0;
			this.programCounter++;
			return;
		}
